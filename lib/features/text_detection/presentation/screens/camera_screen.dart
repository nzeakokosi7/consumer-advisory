...
class _CameraViewState extends State<CameraView> {
  ...
  Widget _capturedBody(BuildContext context) {
    return Container(
      color: Colors.black,
      child: Stack(
        fit: StackFit.expand,
  ...
  Widget _backToCameraButton() => Positioned(
        top: 40,
        left: 8,
        child: SizedBox(
          height: 50.0,
  ...
  Widget _proceedToAdvisoryButton(BuildContext context) => Positioned(
        bottom: 8,
        right: 8,
        child: SizedBox(
          height: 50.0,
          ...
          child: FloatingActionButton(
            heroTag: Object(),
            onPressed: () => _goToAdvisory(context),
            backgroundColor: Colors.black54,
            child: const Row(
              children: [
                Text(
                ...
                SizedBox(width: AppBorderRadius.normal),
                Icon(
                  Icons.arrow_forward,
                  size: 25,
                  color: Colors.white,
  ...
  void _goToAdvisory(BuildContext context) {
    context.push(NewAdvisoryScreen.route, extra: _imagePath);
  }
